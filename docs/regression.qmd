...
format: 
  html:
    code-tools: true
    toc: false
    abstract: "This analysis explores the factors influencing departure delays for flights, using regression models 
  to evaluate the impact of predictors such as wind speed, visibility, temperature, and precipitation. 
  Several models were compared based on Akaike Information Criterion (AIC) and variance explained (R²). 
  The final model identified visibility and wind speed as significant predictors, though the overall 
